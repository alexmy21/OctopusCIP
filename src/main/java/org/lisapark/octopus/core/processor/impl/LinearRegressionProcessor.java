...
//    private static final String DEFAULT_NAME = "ЛинейнаяРегрессия";
//    private static final String DEFAULT_DESCRIPTION = "Вычисляет параметры линейной регрессионной модели для двух последовательностей";
//    private static final String DEFAULT_WINDOW_LENGTH_DESCRIPTION = "Количество наблюдаемых значений, которые используются для построения уравнения регрессии ";
//    private static final String DEFAULT_OUTPUT_DESCRIPTION = "Результат представлен двумя параметрами линейного уравнения" + 
//            " регрессии - коэффициентом и свободным членом";
